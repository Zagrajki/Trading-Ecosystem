...
namespace Common {
    ...
    /// Called to publish outgoing data from the buffers as well as check as check for and callback if data ia available in the read buffers.
    auto TCPSocket::sendAndRecv() noexcept -> bool {
        ...
        // Non-blocking call to read available adata.
