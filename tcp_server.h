...
namespace Common
{
    ...
    /// Publish outgoing data drom the send buffer and read incoming data from the receive buffer.
    ...
    public:
        ...
        /// Collections of all sockets, sockets for incoming data, sockets for outgoing data and dead connections.
